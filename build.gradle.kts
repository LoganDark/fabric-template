...
val yarn_mappings = providers.gradleProperty("yarn_mappings").get()
val loader_version = providers.gradleProperty("loader_version").get()
val mod_dependencies = providers.gradleProperty("mod_dependencies").get()
val fabric_api_version = providers.gradleProperty("fabric_api_version").get()
val fabric_api_modules = providers.gradleProperty("fabric_api_modules").get()
val java_version = providers.gradleProperty("java_version").get()
val java_target = providers.gradleProperty("java_target").get()

val mod_group = providers.gradleProperty("mod_group").get()
val mod_package = providers.gradleProperty("mod_package").get()
val mod_class = providers.gradleProperty("mod_class").get()
...
val mod_description = providers.gradleProperty("mod_description").get()
...
val generateModSources = tasks.register("generateModSources") {
...
val generateTestmodSources = tasks.register("generateTestmodSources") {
